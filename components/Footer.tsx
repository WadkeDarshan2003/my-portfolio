      ...
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-24 mb-16 md:mb-20">
          ...
          <div className="space-y-6 md:space-y-8 flex flex-col justify-center text-center md:text-left">
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-poppins font-semibold text-slate-900 dark:text-neutral-100 leading-tight">
              Have an idea? <br />
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-slate-500 dark:text-neutral-500">
